...
> Spoiler: I f*cked up, I thought of writing very detailed blog post but lost motivation because this blog got some bugs and while solving them, I got annoyed and cut down the blog post to 1/3 of the original(which I had planned of writing) blog post. but don't worry I've added links for some parts which I wanted to explain but couldn't
...
### First of all, let me tell you what we cover today:
...
Now you might think that, I've created the token and baught 20% of that for my self now what?

pump.fun follows "some" process which determined what next will happend to your token. now what's that process?\
The process is simple, when people buy your token price go up and when people sell the token price goes down.(it works same as zerodha or binance) now when your token reaches certain market
...
![Blahb blah blah](https://media1.tenor.com/m/sYCCQ6xLhtYAAAAd/friends-rachel-green.gif)
Now let's understand this so called *bonding curve* with an example which will be easy to understand.\
so if you're reading this that means you might know about what is bit coin and other some basic information about it.
...
// a lot of information needs to be covered... :(
