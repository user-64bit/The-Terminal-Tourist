	...
	return (
		<>
			<div className='border sticky top-0 z-50 bg-[#212529]'>
				<h1 className='text-center text-2xl'><span className="text-red-500">T</span>he<span className="text-red-500">T</span>erminal<span className="text-red-500">T</span>ourist</h1>
